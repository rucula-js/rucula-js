...
Rucula é um projeto que elimina toda carga repetitiva presente na criação de novas interfaces de usuário.

Rucula presta suporte para
- Criação de telas ✅
- Criação de inputs e consistências ✅
- Criação de Objeto Modelo ✅
- Controle de dependências em inputs ✅
- Solicitações HTTP ✅
