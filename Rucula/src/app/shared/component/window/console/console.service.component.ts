...
export class ConsoleService{
    ...
    constructor(private dependencies:TableDependencyService, private obj:FactoryObjectService){}
    ...
    private outputDependencies(){
        let dependecies = this.dependencies.getDependencies();
        let output ='<br>'; 
    ...
    private outputGetObject(){
        ...
        output += '<h6>Objeto Atual</h6>';
            output+=`<div style="color:#0b6ca5;">${JSON.stringify(this.obj.object)}</div>`
        this.consolePanel.innerHTML = output
    }
}