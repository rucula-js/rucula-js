...
namespace Rucula.Infra.Migrations
{
    ...
    [Migration("20230107035406_AddDescriptionContentEstruture")]
    partial class AddDescriptionContentEstruture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rucula.Domain.TagMetaHTML", b =>
                {
                    ...
                    b.Property<string>("ContentHTMLGuuid")
                        .HasColumnType("character varying(36)");
            ...
            modelBuilder.Entity("Rucula.Domain.TagMetaHTML", b =>
                {
                    b.HasOne("Rucula.Domain.ContentHTML", "ContentHTML")
                        .WithMany()
                        .HasForeignKey("ContentHTMLGuuid");
